...
public class UIToggle : UIWidgetContainer
{
    ...
    public bool keepStateOnEnable = true;
    ...
    /// </summary>
    [HideInInspector] [SerializeField] private UISprite checkSprite = null;

    [HideInInspector] [SerializeField] private Animation checkAnimation;
    [HideInInspector] [SerializeField] private GameObject eventReceiver;
    [HideInInspector] [SerializeField] private string functionName = "OnActivate";
    [HideInInspector] [SerializeField] private bool startsChecked = false; // Use 'startsActive' instead
    ...
    void Awake()
    {
        UIEventListener.Get(this.gameObject).onClick += SelectTab;
    }
    private void OnEnable()
    {
        list.Add(this);
        if (!keepStateOnEnable)
        {
            Set(startsActive);
        }
    }
    ...
    /// </summary>
    protected virtual void SelectTab(GameObject obj)
    {
    ...
    protected virtual void OnSet(bool isActive)
    {
    }
}