...
public class UIProgressBar : UIWidgetContainer
{
    ...
    protected virtual void OnChangeValue(float value)
    {
    }
    ...
    public float alpha
    {
        ...
        set
        {
            ...
            {
                mFG.alpha = value;
                if (mFG.collider != null) mFG.collider.enabled = mFG.alpha > 0.0001f;
                else if (mFG.GetComponent<Collider2D>() != null)
                    mFG.GetComponent<Collider2D>().enabled = mFG.alpha > 0.0001f;
            }

            if (mBG != null)
            {
                mBG.alpha = value;
                if (mBG.collider != null) mBG.collider.enabled = mBG.alpha > 0.0001f;
                else if (mBG.GetComponent<Collider2D>() != null)
                    mBG.GetComponent<Collider2D>().enabled = mBG.alpha > 0.0001f;
            }
            ...
            if (thumb != null)
            {
                ...
                {
                    w.alpha = value;
                    if (w.collider != null) w.collider.enabled = w.alpha > 0.0001f;
                    else if (w.GetComponent<Collider2D>() != null)
                        w.GetComponent<Collider2D>().enabled = w.alpha > 0.0001f;
                }
            }
#else
			if (mFG != null)
    ...
    {
        get { return (mFill == FillDirection.LeftToRight || mFill == FillDirection.RightToLeft); }
    }
    ...
    {
        get { return (mFill == FillDirection.RightToLeft || mFill == FillDirection.TopToBottom); }
    }
