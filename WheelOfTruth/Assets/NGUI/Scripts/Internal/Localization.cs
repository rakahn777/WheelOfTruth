...
public static class Localization
{
    ...
    public static List<EventDelegate> onChangeLanguage = new List<EventDelegate>();
    ...
    static public string language
    {
        ...
        set
        {
            if (mLanguage != value)
            {
                mLanguage = value;
                LoadAndSelect(value);
                if (onChangeLanguage != null && onChangeLanguage.Count > 0) EventDelegate.Execute(onChangeLanguage);
            }
        }
    }
    ...
    static bool LoadDictionary(string value)
    {
        ...
        if (!localizationHasBeenSet)
        {
            ...
            {
                TextAsset asset = Resources.Load<TextAsset>("Config/Localization");
