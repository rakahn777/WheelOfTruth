...
public class UILabel : UIWidget
{
    ...
    public EventDelegate onChangeValue = new EventDelegate();

    [HideInInspector] [SerializeField] private Font mTrueTypeFont;
    [HideInInspector] [SerializeField] private UIFont mFont;
#if !UNITY_3_5
    [MultilineAttribute(6)]
#endif
    [HideInInspector] [SerializeField] private string mText = "";

    [HideInInspector] [SerializeField] private int mFontSize = 16;
    [HideInInspector] [SerializeField] private FontStyle mFontStyle = FontStyle.Normal;
    [HideInInspector] [SerializeField] private Alignment mAlignment = Alignment.Automatic;
    [HideInInspector] [SerializeField] private bool mEncoding = true;
    [HideInInspector] [SerializeField] private int mMaxLineCount = 0; // 0 denotes unlimited
    [HideInInspector] [SerializeField] private Effect mEffectStyle = Effect.None;
    [HideInInspector] [SerializeField] private Color mEffectColor = Color.black;
    [HideInInspector] [SerializeField] private NGUIText.SymbolStyle mSymbols = NGUIText.SymbolStyle.Normal;
    [HideInInspector] [SerializeField] private Vector2 mEffectDistance = Vector2.one;
    [HideInInspector] [SerializeField] private Overflow mOverflow = Overflow.ShrinkContent;
    [HideInInspector] [SerializeField] private Material mMaterial;
    [HideInInspector] [SerializeField] private bool mApplyGradient = false;
    [HideInInspector] [SerializeField] private Color mGradientTop = Color.white;
    [HideInInspector] [SerializeField] private Color mGradientBottom = new Color(0.7f, 0.7f, 0.7f);
    [HideInInspector] [SerializeField] private int mSpacingX = 0;
    [HideInInspector] [SerializeField] private int mSpacingY = 0;
    [HideInInspector] [SerializeField] private bool mUseFloatSpacing = false;
    [HideInInspector] [SerializeField] private float mFloatSpacingX = 0;
    [HideInInspector] [SerializeField] private float mFloatSpacingY = 0;

    // Obsolete values
    [HideInInspector] [SerializeField] private bool mShrinkToFit = false;
    [HideInInspector] [SerializeField] private int mMaxLineWidth = 0;
    [HideInInspector] [SerializeField] private int mMaxLineHeight = 0;
    [HideInInspector] [SerializeField] private float mLineWidth = 0;
    [HideInInspector] [SerializeField] private bool mMultiline = true;

#if DYNAMIC_FONT
    [System.NonSerialized] private Font mActiveTTF = null;
    ...
    {
        get { return base.isAnchoredHorizontally || mOverflow == Overflow.ResizeFreely; }
    }
    ...
    {
        get { return (mFont != null) ? (UnityEngine.Object) mFont : (UnityEngine.Object) mTrueTypeFont; }
        set
        {
    ...
    {
        get { return (trueTypeFont != null) ? mFontSize : (mFont != null ? mFont.defaultSize : 16); }
    }
    ...
    {
        get { return mUseFloatSpacing ? mFloatSpacingY : mSpacingY; }
    }
    ...
    {
        get { return mUseFloatSpacing ? mFloatSpacingX : mSpacingX; }
    }
    ...
    {
        get { return mFont != null || mTrueTypeFont != null; }
    }
#else
    ...
    /// </summary>
    public void PrintOverlay(int start, int end, UIGeometry caret, UIGeometry highlight, Color caretColor,
    ...
    /// </summary>
    public void ApplyShadow(BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols, int start,
        int end, float x, float y)
    {
        ...
        for (int i = start; i < end; ++i)
        {
            ...
            else
            {
                Color fc = c;
                fc.a = (uc.a/255f*c.a);
                cols.buffer[i] = (bitmapFont != null && bitmapFont.premultipliedAlphaShader)
                    ? NGUITools.ApplyPMA(fc)
                    : fc;
            }
        }
    }
