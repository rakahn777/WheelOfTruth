...
public class UICamera : MonoBehaviour
{
    ...
    public class MouseOrTouch
    {
        ...
        {
            get { return touchBegan ? RealTime.time - pressTime : 0f; }
        }
    ...
    {new MouseOrTouch(), new MouseOrTouch(), new MouseOrTouch()};
    ...
    public static GameObject selectedObject
    {
        ...
        set { SetSelection(value, UICamera.currentScheme); }
    }
    ...
    /// </summary>
    private System.Collections.IEnumerator ChangeSelection()
    {
    ...
    public static bool Raycast(Vector3 inPos)
    {
        for (int i = 0; i < list.size; ++i)
        {
            ...
            float dist = (cam.rangeDistance > 0f)
                ? cam.rangeDistance
    ...
    {
        if (button > -0 && button < mMouse.Length)
        {
